...
const Profile = () => {
    ...
    const [patientRatings, setPatientRatings] = useState<any[]>([]);
    ...
    useEffect(() => {
        if (user) {
            ...
            // Fetch patient ratings if user is a patient
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                {user.role === "patient" && patientRatings.length > 0 && (
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden mt-6">
                        <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 px-6 py-4">
                            ...
                            <p className="text-yellow-100 text-sm">
                                Reviews and ratings you've given to doctors
                            </p>
                        </div>
                        
                        <div className="p-6">
                            <div className="space-y-6">
                                {patientRatings.slice(0, 5).map((rating) => (
                                    <div key={rating._id} className="border border-gray-200 rounded-lg p-4">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center space-x-2 text-sm text-gray-600">
                                                ...
                                                <span>
                                                    Consultation: {formatDate(rating.appointment.appointmentDate)}
                                                </span>
                                            </div>
                                            <div className="text-sm text-gray-600">
                                                <span className="font-medium">Reason:</span> {rating.appointment.reason}
                                            </div>
                                            {rating.review && (
